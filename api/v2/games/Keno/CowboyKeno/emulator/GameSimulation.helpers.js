const kenoRng = require("../../../../helpers/rng/kenoRng.helper");

function createBaseRequest(last_state) {
  let numCount = Math.floor(Math.random() * 9) + 2;
  let drawnNumbers = kenoRng.getKenoNumbers(1, 80, numCount);
  let baseRequest = {
    type: "BASE",
    credits: 1,
    bet: 2,
    ...
    nextStateDetails: last_state ? last_state.nextStateDetails : {},
    //Details
    playerId: "1",
    gameId: "2010",
  };
