...
async function gamePlayMiddlewareBuffalo(req, res, next) {
  try {
    //Validation
    ...
    req.body.gameId = "1001"; //NOTE - Hardcoded GameId
...
async function gameContinueMiddlewareBuffalo(req, res, next) {
  try {
    //Validation
...
async function gameDoneMiddlewareBuffalo(req, res, next) {
  try {
    //Validation
...
async function gameResumeMiddlewareBuffalo(req, res, next) {
  try {
    //Validation
...
module.exports = {
  gamePlayMiddlewareBuffalo,
  gameContinueMiddlewareBuffalo,
  gameDoneMiddlewareBuffalo,
  gameResumeMiddlewareBuffalo,
};
