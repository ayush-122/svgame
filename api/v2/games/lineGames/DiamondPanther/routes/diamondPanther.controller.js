...
//  **************** BASE GAME PLAY ******************
async function postGamePlayDiamondPanther(req, res) {
  try {
...
async function postGameContinueDiamondPanther(req, res) {
  try {
...
module.exports = {
  postGamePlayDiamondPanther,
  postGameContinueDiamondPanther,
