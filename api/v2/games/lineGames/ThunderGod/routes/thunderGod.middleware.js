...
async function gamePlayMiddlewareThunderGod(req, res, next) {
  try {
    //Validation
    ...
    req.body.gameId = "1012"; //NOTE - Hardcoded GameId
...
async function gameContinueMiddlewareThunderGod(req, res, next) {
  try {
    //Validation
...
async function gameDoneMiddlewareThunderGod(req, res, next) {
  try {
    //Validation
...
async function gameResumeMiddlewareThunderGod(req, res, next) {
  try {
    //Validation
...
module.exports = {
  gamePlayMiddlewareThunderGod,
  gameContinueMiddlewareThunderGod,
  gameDoneMiddlewareThunderGod,
  gameResumeMiddlewareThunderGod,
};
