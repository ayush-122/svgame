const { SPIN_REQUEST, FREE_GAME_REQUEST, RESPIN_REQUEST } = require("../configuration/GameConstant");
...
class randomPools {
  ...
  async createNew(request) {
    ...
    if (request.type === SPIN_REQUEST) {
      ...
      return this.bonusGamePools(result);
    } else throw "invalid request in pools.";
  }
