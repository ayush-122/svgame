...
class ResponseGenerator {
  ...
  createRespinResponse(responseMap, response) {
    ...
    response.wildBoxFeature.featureReels = responseMap.get(FEATURE_REELS);
    response.wildBoxFeature.featurePaylines = responseMap.get(FEATURE_PAYLINES) || [];
    response.featureWin = responseMap.get(FEATURE_WIN) || 0;
    response.wildBoxFeature.wildBoxPosition = responseMap.get(WILD_BOX) || [];
