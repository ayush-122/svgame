...
//Add Sticky Wild
const stickWild = (matrix, wildPositions) => {
  wildPositions.forEach((element) => {
    matrix[(element[0], element[1])] = WILD_SYMBOL;
  });
  return matrix;
};

module.exports = { SymbolCount, changeSymbolCode, expandingWild, stickWild };
