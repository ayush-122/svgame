...
const { H1, H2, H3, H4, H5, H6, L1, L2, L3, L4, L5, SC, WC } = require("./GameReelSymbol").GameReelSymbol.symbols;
...
baseGameReels.get(GameRTPLevel.RTP_95).set(1, [SC, L1, L4, H2, L3, L1, L1, L2, H2, H6, L3, L4, L2, L3, H4, L2, L4, H5, L4, L3, H1, H3, L2, L3, L3, L4, L3, L3, L4, H6, L4, SC, L2, L4, H3, L4, L2, L3, L5, L4, L5, L5, L5, SC, L5, L5, L5, L5, L5, L2, L5, L5, L5, L5, L4, WC, L1, L1, L1, L1]),
baseGameReels.get(GameRTPLevel.RTP_95).set(2, [H2, L3, L1, H4, H2, L2, WC, L4, H1, L1, H6, H4, L2, L3, L2, WC, L1, L3, L2, H4, L1, L3, L2, L3, SC, H4, L1, L2, H3, H2, H6, L3, H3, SC, L3, L1, L2, L3, H4, SC, H4, L2, L3, H4, L4, H3, L2, SC, H5, L5, H5, H5, L5, L2, L5, H5, L1, L1, L2, L2, L2, L2, L3, L3, L3, L3, L3, L2, L3, L3, L4, L4, L4, L4]);
baseGameReels.get(GameRTPLevel.RTP_95).set(3, [L4, L1, H1, L2, H3, L4, WC, H5, L3, L2, H6, L1, H4, L4, L1, H5, H1, L3, L4, H5, L1, H3, WC, L4, H4, H3, L4, L1, H1, H3, H6, H4, H1, L1, H3, SC, H2, H1, H4, H4, L2, L1, SC, H3, H4, H2, WC, H5, L5, H5, L5, L5, L5, L5, L5, L5, L5, H5, L1, L4, L4, L4, L4]);
baseGameReels.get(GameRTPLevel.RTP_95).set(4, [L3, L4, H3, H4, H1, L3, WC, L1, H2, H4, H6, L3, L2, H3, L1, L3, H3, L1, L4, L1, L2, L4, H4, L3, L2, H6, H4, H1, H2, L2, SC, L4, L2, L1, H2, H4, H1, L1, WC, H2, H3, SC, L1, H1, H2, H4, H3, L2, L3, H4, L3, H5, L5, L5, L5, L5, L5, L3, H5, L5, H3, L1, H3, L1, H1, L1, H5, L4, L4, L4, L4, L4]);
baseGameReels.get(GameRTPLevel.RTP_95).set(5, [L2, H3, L1, L3, L2, H4, WC, H2, L1, L2, H6, L4, SC, H2, L1, H1, H2, L3, WC, H3, H2, L1, WC, L4, L3, H1, H2, L4, L3, L1, H6, L2, H3, H1, H4, L4, L2, H3, L3, H1, H2, H3, L2, H4, L3, L4, H3, H1, H4, L1, H1, H2, H4, L4, H1, L3, L2, L4, H2, H4, SC, H5, L5, H5, L3, H5, L5, L5, L5, H5, H5, SC, L1, H1, L1, L1, H2]);
