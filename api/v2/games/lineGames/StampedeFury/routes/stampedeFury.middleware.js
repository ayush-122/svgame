...
async function gamePlayMiddlewareStampedeFury(req, res, next) {
  try {
    //Validation
    ...
    req.body.gameId = "1013"; //NOTE - Hardcoded GameId
...
async function gameContinueMiddlewareStampedeFury(req, res, next) {
  try {
    //Validation
...
async function gameDoneMiddlewareStampedeFury(req, res, next) {
  try {
    //Validation
...
async function gameResumeMiddlewareStampedeFury(req, res, next) {
  try {
    //Validation
...
module.exports = {
  gamePlayMiddlewareStampedeFury,
  gameContinueMiddlewareStampedeFury,
  gameDoneMiddlewareStampedeFury,
  gameResumeMiddlewareStampedeFury,
};
