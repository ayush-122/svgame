...
async function gamePlayMiddlewareBookOfEgypt(req, res, next) {
  try {
    //Validation
    ...
    req.body.gameId = "1007"; //NOTE - Hardcoded GameId
...
async function gameContinueMiddlewareBookOfEgypt(req, res, next) {
  try {
    //Validation
...
async function gameDoneMiddlewareBookOfEgypt(req, res, next) {
  try {
    //Validation
...
async function gameResumeMiddlewareBookOfEgypt(req, res, next) {
  try {
    //Validation
...
module.exports = {
  gamePlayMiddlewareBookOfEgypt,
  gameContinueMiddlewareBookOfEgypt,
  gameDoneMiddlewareBookOfEgypt,
  gameResumeMiddlewareBookOfEgypt,
};
