...
router.post(
  ...
  fireShortInferno.gamePlayMiddlewareFireShortInferno,
  game.postGamePlayFireShortInferno
);
...
router.put(
  ...
  fireShortInferno.gameDoneMiddlewareFireShortInferno,
  game.postGameDoneFireShortInferno
);
...
router.get(
  ...
  fireShortInferno.gameResumeMiddlewareFireShortInferno,
  game.postGameResumeFireShortInferno
);
