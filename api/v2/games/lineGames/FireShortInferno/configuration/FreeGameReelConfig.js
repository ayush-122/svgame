...
const { H1, H2, H3, H4, H5, L1, L2, L3, L4, BN, WC } = require("./GameReelSymbol").GameReelSymbol.symbols;
...
freeGameReels.get(GameRTPLevel.RTP_95).set(1, [H3, L4, H1, L2, WC, H2, L3, BN, H1, H2, H5, BN, H4, H4, H1, H2, H2, H1, H2, BN, H1, H2, H3, H3, H1, H2, H3, H1]);
freeGameReels.get(GameRTPLevel.RTP_95).set(2, [WC, L3, L1, H2, L2, H1, L4, H1, L1, L3, L4, H3, L1, L3, H1, H1, H2, H4, H5, BN, H3, H2, H1, L3, H3, L3, H1, H2, H2, H1, L2, L4]);
freeGameReels.get(GameRTPLevel.RTP_95).set(3, [L4, L1, L2, H3, L4, H5, L3, L2, L1, L1, L4, L3, L4, H5, H3, H4, H3, H1, H2, H2, H3, H4, H2, H1, L4, H2, H3, H2, H1, L1]);
freeGameReels.get(GameRTPLevel.RTP_95).set(4, [H5, L4, H4, L3, L1, WC, H2, L3, H1, L2, H2, L1, L3, H3, H2, L1, L4, L2, BN, L3, L2, H4, H1, L1, H2, H1, L1, H3, L4, L1, H1, H2, H3, L2, H1]);
freeGameReels.get(GameRTPLevel.RTP_95).set(5, [L1, L2, H3, L1, L3, WC, L2, L1, L2, L4, H2, L1, L3, L1, BN, L3, L4, L3, L1, H3, L2, H3, L3, H2, H4, L3, L4, H1, L1, H1, H2, L4, H1, L3, BN, H4, L2, H5, H5]);
