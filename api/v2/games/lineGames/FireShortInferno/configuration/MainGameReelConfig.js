...
const {H1, H2, H3, H4, H5, L1, L2, L3, L4, WC, BN, BO} = require("./GameReelSymbol").GameReelSymbol.symbols;
...
baseGameReels.get(GameRTPLevel.RTP_95).set(1, [BN, L1, L4, L4, L3, L1, WC, L1, L2, H2, L3, L4, BO, L3, H4, L2, L4, H5, L4, BO, H1, H3, L2, L3, L3, L4, L3, L3, L4, L4, BN, L2, L4, H3, L4, L2, L3, H5, BO, L4, L3, L4, L4, BN, L2, L3, L4, L3, L4, L3, L4, BO, L3, L4, L3, L4, BO, L4, L4, L3, L4, L3, L4, L3, L3, L4, L3, L3, L4, L3, L3, L3, L4, L3]), 
baseGameReels.get(GameRTPLevel.RTP_95).set(2, [H2, L3, L1, H4, H2, L2, L1, L4, H1, BO, H4, L2, L3, L2, WC, L1, L3, L2, H4, L1, L3, L2, L3, BN, H4, L1, L2, H3, BO, L3, H3, BN, L3, L1, L2, L3, H4, BN, H2, H4, L2, L3, H4, L4, H3, L2, BN, H5, L4, H5, H5, L3, L2, L3, H5, L1, L1, L2, L2, L2, L2, L2, L2, L2, L2, L2, L2, L2, L2, L2, L2, L2, L2]);
baseGameReels.get(GameRTPLevel.RTP_95).set(3, [L4, L1, H1, BO, H3, L4, WC, H5, L3, L2, L1, H4, L4, L1, H5, H1, L3, L4, H5, BO, H3, L2, L4, H4, H3, L4, L1, H1, H3, H4, H1, L1, H3, H1, BN, H2, H1, H4, H4, L2, L1, BN, H3, H4, H2, H1, WC, H5, L4, H5, L3, L4, L3, L4, L3, L4, L3, L4, L3, L4, L4, L4, L4, L4, L4, L4, L4, L4]);
baseGameReels.get(GameRTPLevel.RTP_95).set(4, [L3, L4, H3, H4, H1, L3, WC, L1, H2, H4, L3, L2, H3, H2, H3, L1, L3, H1, H3, L1, L4, L1, H2, L2, L4, H1, H4, L3, BO, H4, H1, H3, H2, BN, L2, L1, H2, H4, H1, L1, WC, H2, H3, BN, L1, H1, H2, H4, H3, L2, BO, H4, H1, L3, H1, H5, L1, L1, L1, L1, L1, L1, L1, L1, L1]);
baseGameReels.get(GameRTPLevel.RTP_95).set(5, [L2, H3, L1, L3, L2, H4, WC, H2, L1, L3, L4, BN, H2, L1, H1, H2, L3, WC, H3, H2, L1, L3, BO, L3, H1, H2, L4, BO, L1, L2, H3, H1, H4, L4, L2, H3, L3, H1, H2, H3, BO, H4, L3, L4, H3, H1, H4, BO, H1, H2, H4, L4, H1, L3, L2, L4, H2, H4, BN, H5]);
