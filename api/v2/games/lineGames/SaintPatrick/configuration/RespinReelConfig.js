...
respinGameReels.get(GameRTPLevel.RTP_95).set(1, [H3, L1, L4, L3, L3, L1, H1, L2, H2, L3, L5, L4, H1, H1, H2, H5, WC, H4, H3, H4, H2, H1, H2, H3, H1, H2, H3, H1]);
respinGameReels.get(GameRTPLevel.RTP_95).set(2, [L3, L1, H2, L2, L4, H1, L1, WC, L4, H3, L5, L1, L3, H1, H1, H2, H4, H5, H3, H2, L3, L5, L3, H1, H2, H2, H1, WC]);
...
respinGameReels.get(GameRTPLevel.RTP_95).set(4, [H5, L4, H4, L3, L1, H2, L3, L2, H2, L1, L5, L3, L4, H3, H2, L1, WC, H4, H1, H2, H1, WC, H3, H1, H2, H3]);
respinGameReels.get(GameRTPLevel.RTP_95).set(5, [L1, L2, H3, WC, L3, L2, L1, L2, L4, H2, L5, WC, L3, L1, L3, L4, L3, L1, H3, L2, H3, L3, H2, H4, L3, L4, H1, WC, H1, H2, L5, L4, H1, L3, H4, H5, H5]);
