const {BN,WC,BO} = require("./GameReelSymbol").GameReelSymbol.symbols;

const           GAME_NAME                                        =                             "FireShortInferno";
const       	GAME_DESC                                        =                             "FireShortInferno"; 
const           BASE_CREDITS_BET                                 =                             25;
