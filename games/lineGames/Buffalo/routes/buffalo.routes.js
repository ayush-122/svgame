 ...
 */
//BASE GAME
router.post("/play", isAuthenticated, buffalo.gamePlayMiddlewareBuffalo, game.postGamePlayBuffalo);
 ...
 */
//FREE/BONUS GAME
router.post("/continue", isAuthenticated, buffalo.gameContinueMiddlewareBuffalo, game.postGameContinueBuffalo);
 ...
 */
//DONE REQUEST
router.put("/play", isAuthenticated, buffalo.gameDoneMiddlewareBuffalo, game.postGameDoneBuffalo);
 ...
 */
//Resume Request
router.get("/resume", isAuthenticated, buffalo.gameResumeMiddlewareBuffalo, game.postGameResumeBuffalo);
