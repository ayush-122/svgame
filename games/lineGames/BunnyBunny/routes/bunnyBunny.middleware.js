...
async function gamePlayMiddlewareBunnyBunny(req, res, next) {
  try {
    //Validation
    ...
    req.body.gameId = "1011"; //NOTE - Hardcoded GameId
...
async function gameContinueMiddlewareBunnyBunny(req, res, next) {
  try {
    //Validation
...
async function gameDoneMiddlewareBunnyBunny(req, res, next) {
  try {
    //Validation
...
async function gameResumeMiddlewareBunnyBunny(req, res, next) {
  try {
    //Validation
...
module.exports = {
  gamePlayMiddlewareBunnyBunny,
  gameContinueMiddlewareBunnyBunny,
  gameDoneMiddlewareBunnyBunny,
  gameResumeMiddlewareBunnyBunny,
};
