...
freeGameReels.get(GameRTPLevel.RTP_95).set(1, []);
freeGameReels.get(GameRTPLevel.RTP_95).set(2, []);
freeGameReels.get(GameRTPLevel.RTP_95).set(3, []);
freeGameReels.get(GameRTPLevel.RTP_95).set(4, []);
freeGameReels.get(GameRTPLevel.RTP_95).set(5, []);
