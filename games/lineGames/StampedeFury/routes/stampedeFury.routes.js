 ...
 */
//BASE GAME
router.post("/play", isAuthenticated, stampedeFury.gamePlayMiddlewareStampedeFury, game.postGamePlayStampedeFury);
 ...
 */
//DONE REQUEST
router.put("/play", isAuthenticated, stampedeFury.gameDoneMiddlewareStampedeFury, game.postGameDoneStampedeFury);
...
router.get(
  "/resume",
  isAuthenticated,
  stampedeFury.gameResumeMiddlewareStampedeFury,
  game.postGameResumeStampedeFury
);
