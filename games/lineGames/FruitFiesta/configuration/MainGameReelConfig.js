...
const {H1,H2,H3,H4,H5,L1,L2,L3,L4,L5,WC,BN} = require("./GameReelSymbol").GameReelSymbol.symbols;
...
baseGameReels.get(GameRTPLevel.RTP_95).set(1, [BN, L1, L4, H2, L3, L1, L1, L2, L3, L4, L5, L3, WC, L2, L4, H5, L4, L5, H1, L2, L3, L3, L4, L3, L3, L4, L4, BN, L2, L4, H3, L4, L2, L3, L5, L4, L5, L5, L5, BN, L5, L5, L5, WC, L5, L2, L5, L5, L5, L5, H4, L5, L5, L4, L5, L4, L5, L3, L5, L4, L5, L3, L5, L4, L5, L3, L3, L4, L3, L4, L4, L5, L4, L5, L4, L5, L4, L5, L4, L5]),  
baseGameReels.get(GameRTPLevel.RTP_95).set(2, [L3, L3, L1, L2, H2, L2, L1, L4, H1, L1, L2, L3, L2, L1, L3, L2, WC, L1, L3, L2, L3, BN, L1, L1, L2, L5, L3, H3, BN, L3, L1, L2, L3, BN, H4, L2, L3, H4, L4, H3, L2, BN, H5, L5, H5, H5, L5, L2, L5, WC, L1, L1, L2, L2, L2, L2, L5, L4, L5, L3, L5, L4, L5, L3, L3, L4, L4, L3]);
baseGameReels.get(GameRTPLevel.RTP_95).set(3, [L4, L1, L5, L1, L4, WC, L3, L2, L1, L4, L1, H5, L3, L4, L2, L5, L5, L2, L4, L5, L5, L4, L1, L5, H3, L5, H1, L1, L5, H1, BN, H2, L5, L4, H4, L2, L1, BN, H3, H4, H2, WC, H5, L5, H5, L5, L5, L5, L5, L5, L5, L5, L5, L5, L5, H5, L5, L4, L5, L3, L5, L4, L5, L3, L5, L4, L5, L3]);
baseGameReels.get(GameRTPLevel.RTP_95).set(4, [L3, L4, L3, L1, H2, L3, L2, L3, L4, L2, L3, L4, H2, L3, L1, L3, H1, H5, L1, L4, L1, L4, L2, L4, WC, H4, L3, L5, H1, H3, L2, BN, L4, L2, L1, L1, WC, H3, BN, L1, L2, L3, L3, H4, L2]);
baseGameReels.get(GameRTPLevel.RTP_95).set(5, [L2, L3, L1, L3, L2, WC, L1, L3, L4, BN, L1, L3, WC, H3, L1, L3, L4, L3, L4, L5, L1, L2, L4, L2, L3, L5, L3, L4, H3, L1, H1, H2, H4, L4, H1, L3, L2, L4, H2, H4, BN, H5]);
