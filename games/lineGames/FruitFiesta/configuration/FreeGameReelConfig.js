...
freeGameReels.get(GameRTPLevel.RTP_95).set(1, [H3, L1, L4, L3, BN, L1, H1, L2, L1, H2, L3, L1, L4, H1, L2, H5, H4, BN, L3, H2, H1, H2, H3, H3, H1, H2, H1, H2, H4, H3, H3, H3]);
freeGameReels.get(GameRTPLevel.RTP_95).set(2, [WC, L3, H1, H2, L2, L4, L4, H1, BN, L1, L3, L4, H3, L4, L1, L3, H1, H1, H2, BN, H5, L5, L4, H3, H2, L3, H3, L3, H1, H2, H2, H1, H1]);
freeGameReels.get(GameRTPLevel.RTP_95).set(3, [L4, L1, L2, H3, L4, L4, H5, L3, L4, L2, L1, L1, WC, L4, L1, L3, L4, BN, H3, L4, H4, H3, H1, H2, H2, L5, L3, H3, H4, H2, H1, H2, H3, H2, H1, L1]);
freeGameReels.get(GameRTPLevel.RTP_95).set(4, [H5, L4, H4, L3, L1, L4, H2, L3, L4, BN, H2, L1, L3, H3, H2, L1, L4, L2, L4, L5, L3, L3, L2, H4, H1, L3, L1, H2, WC, H1, L1, H3, L4, L4, L1, H1, H2, H3, L2, L5, H1]);
freeGameReels.get(GameRTPLevel.RTP_95).set(5, [L1, L2, H3, L1, L3, WC, L2, L1, L2, L4, H2, L1, L3, L1, L4, L3, L4, H1, L1, H3, L2, H3, L3, H2, L3, H4, L3, L4, H1, L1, BN, H2, L4, H1, L3, L2, H4, L5, H5, L5, L5, L5, H5]);
