...
async function gamePlayMiddlewareFruitFiesta(req, res, next) {
  try {
    //Validation
    ...
    req.body.gameId = "1014"; //NOTE - Hardcoded GameId
...
async function gameContinueMiddlewareFruitFiesta(req, res, next) {
  try {
    //Validation
...
async function gameDoneMiddlewareFruitFiesta(req, res, next) {
  try {
    //Validation
...
async function gameResumeMiddlewareFruitFiesta(req, res, next) {
  try {
    //Validation
...
module.exports = {
  gamePlayMiddlewareFruitFiesta,
  gameContinueMiddlewareFruitFiesta,
  gameDoneMiddlewareFruitFiesta,
  gameResumeMiddlewareFruitFiesta,
};
