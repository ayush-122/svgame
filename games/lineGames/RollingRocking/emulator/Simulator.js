...
function printResponse() {
  ...
  const baseWildPercentage = (responseObj.totalBaseWildWon / responseObj.totalBet) * 100;
  const freeWildPercentage = (responseObj.totalFreeWildWon / responseObj.totalBet) * 100;
