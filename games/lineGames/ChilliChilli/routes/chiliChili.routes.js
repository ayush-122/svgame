 ...
 */
//BASE GAME
router.post("/play", isAuthenticated, chiliChili.gamePlayMiddlewareChiliChili, game.postGamePlayChiliChili);
 ...
 */
//FREE/BONUS GAME
router.post("/continue", isAuthenticated, chiliChili.gameContinueMiddlewareChiliChili, game.postGameContinueChiliChili);
 ...
 */
//DONE REQUEST
router.put("/play", isAuthenticated, chiliChili.gameDoneMiddlewareChiliChili, game.postGameDoneChiliChili);
 ...
 */
//Resume Request
router.get("/resume", isAuthenticated, chiliChili.gameResumeMiddlewareChiliChili, game.postGameResumeChiliChili);
