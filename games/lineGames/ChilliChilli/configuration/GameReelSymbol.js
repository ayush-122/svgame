const GameReelSymbol = {
  ...
  symbolIds: {
    ...
    L6: { id: 10, symbol: "L6", symbolWon: true, matchCount: 3 },
    L7: { id: 11, symbol: "L7", symbolWon: true, matchCount: 3 },
    SC: { id: 12, symbol: "SC", symbolWon: false, matchCount: 3 },
    WC: { id: 13, symbol: "WC", symbolWon: true, matchCount: 3 },
    BO: { id: 14, symbol: "BO", symbolWon: false, matchCount: 3 },
  },
  ...
  getSymbolById: (id) => {
    try {
      for (const key in this.symbols) {
        if (
          Object.prototype.hasOwnProperty.call(this.symbols, key) &&
          this.symbols[key].id === id
        ) {
          return key;
        }
      }
