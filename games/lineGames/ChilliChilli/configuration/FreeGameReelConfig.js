...
freeGameReels.get(GameRTPLevel.RTP_60).set(1, [H3, L1, L4, L3, L1, WC, H1, L2, WC, L3, L4, L6, L7, L2, H5, L2, WC, L2, H4, H4, WC, WC, L5, H2, L3, WC, L4, L5, L5, L4, L4, L5, L6, L6, L6, L7]);
freeGameReels.get(GameRTPLevel.RTP_60).set(2, [WC, L3, L1, H2, L2, WC, L4, H1, WC, L1, L3, L6, L7, L4, H3, WC, L1, L3, H1, H1, H2, H4, H5, L5, WC, H3, H2, WC, H3, L3, H1, L4, L6, L6, L6, L7]);
freeGameReels.get(GameRTPLevel.RTP_60).set(3, [L4, L1, L2, H3, L4, WC, H5, L3, WC, L2, L1, L6, L7, L1, WC, L4, L1, L3, L4, H5, H3, WC, H4, H3, H1, L5, WC, L3, H3, H4, H1, L4, H3, L5, L1, H2, L7]);
freeGameReels.get(GameRTPLevel.RTP_60).set(4, [H5, L4, H4, L3, L1, WC, H2, L3, WC, L2, H2, L6, L7, L3, H3, H2, L4, L2, L4, WC, L3, L2, H4, H1, WC, L1, H2, WC, H1, L1, H3, WC, L4, L1, H1, H2, H3, WC, L5]);
freeGameReels.get(GameRTPLevel.RTP_60).set(5, [L1, L2, H3, L1, L3, WC, L2, L1, L2, L4, H2, L6, L7, L1, L3, L1, WC, L3, L4, L3, L1, H3, L2, H3, L3, H2, WC, H4, L3, L4, H1, L1, H1, H2, L4, H1, L3, L2, H4, L5, H5, L5, WC]);
...
freeGameReels.get(GameRTPLevel.RTP_95).set(1, [H3, L1, L4, L3, L1, WC, H1, L2, WC, L3, L4, L6, L7, L2, H5, L2, WC, L2, H4, H4, WC, WC, L5, H2, L3, WC, L4, L5, L5, H1, H3, H1, WC]);
freeGameReels.get(GameRTPLevel.RTP_95).set(2, [WC, L3, L1, H2, L2, WC, L4, H1, WC, L1, L3, L6, L7, L4, H3, WC, L1, L3, H1, H1, H2, H4, H5, L5, WC, H3, H2, WC, H3, L3, H1, WC, H2, WC, H2, WC, H1, H1]);
freeGameReels.get(GameRTPLevel.RTP_95).set(3, [L4, L1, L2, H3, L4, WC, H5, L3, WC, L2, L1, L6, L7, L1, WC, L4, L1, L3, L4, H5, H3, WC, H4, H3, H1, L5, WC, L3, H3, H4, H1, L4, H3, L5, L1, H2, H2, WC]);
freeGameReels.get(GameRTPLevel.RTP_95).set(4, [H5, L4, H4, L3, L1, WC, H2, L3, WC, L2, H2, L6, L7, L3, H3, H2, L4, L2, L4, WC, L3, L2, H4, H1, WC, L1, H2, WC, H1, L1, H3, WC, L4, L1, H1, H2, H3, WC, L5, H1]);
freeGameReels.get(GameRTPLevel.RTP_95).set(5, [L1, L2, H3, L1, L3, WC, L2, L1, L2, L4, H2, L6, L7, L1, L3, L1, WC, L3, L4, L3, L1, H3, L2, H3, L3, H2, WC, H4, L3, L4, H1, L1, H1, H2, L4, H1, L3, L2, H4, L5, H5, L5, WC]);
