...
baseGameReels.get(GameRTPLevel.RTP_95).set(1, []), 
baseGameReels.get(GameRTPLevel.RTP_95).set(2, []);
baseGameReels.get(GameRTPLevel.RTP_95).set(3, []);
baseGameReels.get(GameRTPLevel.RTP_95).set(4, []);
baseGameReels.get(GameRTPLevel.RTP_95).set(5, []);
