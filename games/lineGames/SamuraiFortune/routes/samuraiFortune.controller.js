...
//  **************** BASE GAME PLAY ******************
async function postGamePlaySamuraiFortune(req, res) {
  try {
...
async function postGameContinueSamuraiFortune(req, res) {
  try {
...
module.exports = {
  postGamePlaySamuraiFortune,
  postGameContinueSamuraiFortune,
