 ...
 */
//BASE GAME
router.post("/play", isAuthenticated, wildGold.gamePlayMiddlewareWildGold, game.postGamePlayWildGold);
 ...
 */
//FREE GAME
router.post("/continue", isAuthenticated, wildGold.gameContinueMiddlewareWildGold, game.postGameContinueWildGold);
 ...
 */
//DONE REQUEST
router.put("/play", isAuthenticated, wildGold.gameDoneMiddlewareWildGold, game.postGameDoneWildGold);
 ...
 */
//Resume Request
router.get("/resume", isAuthenticated, wildGold.gameResumeMiddlewareWildGold, game.postGameResumeWildGold);
