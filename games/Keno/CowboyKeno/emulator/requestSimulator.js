  ...
  try {
    ...
    for (let i = 1; i <= cycles; i++) {
      ...
      if (i % 100000 == 0) {
        ...
        // //For test
        // console.log("Base Won: ", totalBaseWon);
        // console.log("Extra Draw Won", totalExtraDrawWon);
        // console.log("Extra Draw Hit: ", totalBuletteHit);
        ...
        console.log(
          `Skull Hit Percentage: ${skullHitPercentage}, Hat Hit Percentage: ${hatHitPercentage}, Bulette Hit Percentage: ${buletteHitPercentage}, Multiplier Percentage: ${multiplierPercentage}`
        );
        console.log(
          `Free Skull Hit Percentage: ${freeSkullHitPercentage}, Free Bulette Hit Percentage: ${freeBuletteHitPercentage}, Free Multiplier Percentage: ${freeMultiplierPercentage}\n`
        );
      }
    }
