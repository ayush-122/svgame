...
class ResponseGenerator {
  ...
  createResponse(responseMap, response) {
    ...
    response.nextStateDetails.extraDrawCount = responseMap.get(EXTRA_DRAW_COUNT);
    ...
    if (responseMap.get(IS_WHEEL_BONUS)) {
      ...
      response.nextStateDetails.totalWheelBonusWon = responseMap.get(WHEEL_BONUS_WON);
      response.wheelBonusWin = responseMap.get(TOTAL_WHEEL_BONUS_WON);
    }
