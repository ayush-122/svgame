 ...
 */
//BASE GAME
router.post("/play", isAuthenticated, cowboyKeno.gamePlayMiddlewareCowboyKeno, game.postGamePlayKeno);
 ...
 */
//FREE GAME
router.post("/free", isAuthenticated, cowboyKeno.gamePlayMiddlewareCowboyKeno, game.postFreeKeno);
 ...
 */
//CONTINUE GAME
router.post("/continue", isAuthenticated, cowboyKeno.gameContinueMiddlewareCowboyKeno, game.postContinueKeno);
 ...
 */
//CONTINUE GAME
router.put("/continue", isAuthenticated, cowboyKeno.gameContinueMiddlewareCowboyKeno, game.postAcceptWheelKeno);
 ...
 */
//DONE REQUEST
router.put("/play", isAuthenticated, cowboyKeno.gameDoneMiddlewareCowboyKeno, game.postGameDoneKeno);
 ...
 */
//Resume Request
router.get("/resume", isAuthenticated, cowboyKeno.gameResumeMiddlewareCowboyKeno, game.postGameResumeCowboyKeno);
